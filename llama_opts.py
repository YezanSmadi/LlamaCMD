        ...
        if trim_choice.lower() == "y":
            ...
            while True:
                ...
                confirmation = input(colored(
                    f"Okay, so we're trimming ", "light_magenta") + colored(llama_scripts.input_name, "light_yellow") + colored(" starting from ", "light_magenta") + colored(trim_start, "light_yellow") + colored(" for ", "light_magenta") + colored(trim_len, "light_yellow") + colored(" long, with the name of ", "light_magenta") + colored(output_name, "light_yellow") + colored(". Continue?", "light_magenta") + colored(" [y/N]: ", "cyan")).strip()
            ...
            while True:
                ...
                confirmation = input(colored(f"Okay, so we're re-encoding the entirety of ", "light_magenta") + colored(llama_scripts.input_name, "light_yellow") + colored(
                    " into ", "light_magenta") + colored(output_name, "light_yellow") + colored(". ", "light_magenta") + colored("Continue? [y/n]: ", "cyan")).strip()
                if confirmation.lower() == "y":
